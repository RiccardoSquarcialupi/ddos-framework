...
//import it.pps.ddos.utils.TextType.StringType
//
...
//        val stateA = BasicState[String](StringType("A"))
//        val stateB = BasicState[String](StringType("B"))
//        val stateC = BasicState[String](StringType("C"))
